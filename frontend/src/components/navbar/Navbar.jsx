            ...
            <div className="navbar-start">
                <div className="dropdown">
                    ...
                    <ul tabIndex={0} className="menu menu-sm dropdown-content mt-3 z-[1] p-2 shadow bg-base-100 rounded-box w-52">
                        ...
                        <Link to={`/analytics/${authUser._id}`} >
                            <li><a>Analytics</a></li>
                        </Link>
                    </ul>
                </div>
                <img src="/src/assets/images/logo.png" alt="" className='h-12 ml-0 lg:ml-4' />
                <a className="btn btn-ghost text-xl hidden md:flex">MyBOT</a>
            </div>
                ...
                <div className="dropdown dropdown-end">
                    <div tabIndex={0} role="button" className="btn btn-ghost btn-circle">
                        <div className="indicator">
                            ...
                            <span className="badge badge-sm indicator-item back bg-sky-300">100</span>
                        </div>
                    </div>
